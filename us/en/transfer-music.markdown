...
1. Log in to your Ooma Office Manager at [{{ site.office_link.us }}]({{ site.office_link.us }}) and navigate to "[Preferences]({{ site.office_link.us }}/#preferences)" under the "Setup" tab.
