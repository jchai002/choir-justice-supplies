...
1. Log into your Ooma Office Manager at [{{ site.office_link.uk }}]({{ site.office_link.uk }}/) and navigate to "[Settings]({{ site.office_link.uk }}/#settings)" under the "Account" tab, as shown in the following illustration: \\
