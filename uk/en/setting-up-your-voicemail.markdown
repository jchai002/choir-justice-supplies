...
1. Navigate to the Ooma Office web portal at [{{ site.office_link.uk }}]({{ site.office_link.uk }}/) and navigate to the "Extensions" option beneath the "Setup" tab.
...
4. Ask the extension owner to dial [*][9][8] from any IP phone that is connected to the Ooma Office system and enter the temporary PIN when prompted.
