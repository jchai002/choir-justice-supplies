...
Sending and receiving faxes is a necessity for most businesses. Ooma offers an alternative to a physical fax machine with virtual faxing. Since users can send faxes straight from the End User Portal, virtual faxing can give a small business the flexibility to allow its users to work from anywhere. 
...
To learn more about our pricing structure for additional services and capacity, please visit our [pricing chart](/uk/en/ooma-office-pricing-chart).

## How do I sign up for virtual fax?

You can sign up for virtual fax by following these instructions:

1. Log into [{{ site.office_link.uk }}/]({{ site.office_link.uk }}/) as an administrator and navigate to the [Manage Extensions]({{ site.office_link.uk }}/extensions) screen.
...
1. Log into the End User Portal at [{{ site.office_link.uk }}/]({{ site.office_link.uk }}/) and navigate to the [Send Fax]({{ site.office_link.uk }}/fax_send) option beneath the Home tab. 
