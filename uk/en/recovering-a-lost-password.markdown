...
1. Visit the Ooma Office Manager at [{{ site.office_link.uk }}]({{ site.office_link.uk }}/), select the appropriate flag for your country from the dropdown, and then click the "password reset" link at the bottom: \\
...
4. When access to the account is regained, don't forget to follow the "[Changing your account password](/uk/en/changing-your-account-password)" instructions to update your Ooma Office password!