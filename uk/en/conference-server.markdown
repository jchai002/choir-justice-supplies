...
1. Log into your Ooma Office Manager at [{{ site.office_link.uk }}]({{ site.office_link.uk }}/) and navigate to "[Conferences]({{ site.office_link.uk }}/#conferences)" under the "Setup" tab, as shown in the following illustration: \\
...
1. Click the "Settings" ( ![settings]({{ site.baseurl }}/assets/images/ooma_office_manager/settings.png) ) button next to the conference room you would like to update.
...
## How many conference rooms can I have at a given time?

You can have up to ten conference rooms.

## How many people can use a conference room at a time?

You can bring up to ten participants into a conference room.

## How do I delete the conference server?

1. Log into your Ooma Office Manager at [{{ site.office_link.uk }}]({{ site.office_link.uk }}/) and navigate to "[Conferences]({{ site.office_link.uk }}/#conferences)" under the "Setup" tab.
