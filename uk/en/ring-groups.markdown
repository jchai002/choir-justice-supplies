...
1. Go to the Extensions web page at [{{ site.office_link.uk }}/extensions]({{ site.office_link.uk }}/extensions).
2. Click the "Settings" ( ![settings]({{ site.baseurl }}/assets/images/ooma_office_manager/settings.png) ) button for the ring group you would like to update.
...
1. Go to the Extensions web page at [{{ site.office_link.uk }}/extensions]({{ site.office_link.uk }}/extensions).
2. Click the "Trash" ( ![trash]({{ site.baseurl }}/assets/images/ooma_office_manager/trash.png)) ) button for the ring group you would like to delete.
...
1. Go to the Extensions web page at [{{ site.office_link.uk }}/extensions]({{ site.office_link.uk }}/extensions).
2. Click the "Settings" ( ![settings]({{ site.baseurl }}/assets/images/ooma_office_manager/settings.png) ) button for the ring group you would like to update.
3. Click the "Advanced" tab to configure your ring group's advanced settings: \\
...
1. Go to the Phone Numbers web page at [{{ site.office_link.uk }}/#manage_phone_number]({{ site.office_link.uk }}/#manage_phone_number). 
...
3. Click the extension associated with the phone number that you would like to remap and select your desired ring group from the dropdown list.
