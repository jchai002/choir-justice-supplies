...
{% comment %}
	...
	1. Navigate to the Ooma Office Portal at [office.ooma.com]({{ site.office_link.au }}) and login as an administrator, then navigate to "[Extensions]({{ site.office_link.au }}/extensions)" under the "Setup" tab.
