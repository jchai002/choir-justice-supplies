...
1. Log into your Ooma Office Manager at [{{ site.office_link.fr }}]({{ site.office_link.fr }}) and navigate to "[Preferences](https://office.ooma.com/#preferences)" under the "Setup" tab.
