...
Once the user has this information, he or she can log into the End User Portal by visiting [office.ooma.fr/user]({{ site.office_link.fr }}/user) and following the instructions in [this FAQ](/fr/en/ooma-end-user-portal).
...
1. Navigate to the Ooma Office Portal at [office.ooma.fr]({{ site.office_link.fr }}) and log in as an administrator.
...
{% comment %}
	...
	1. Navigate to the Ooma Office Portal at [office.ooma.fr]({{ site.office_link.fr }}) and log in as an administrator, then navigate to "[Extensions]({{ site.office_link.fr }}/extensions)" under the "Setup" tab.
